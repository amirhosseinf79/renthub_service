	...
	return &service{
		...
		apiSettings: dto.ApiSettings{
			...
			Endpoints: dto.ApiEndpoints{
				...
				GetCalendarPrice:   dto.EndP{Address: "/taraaz/v1/pricing/management/accommodation/%v", Method: "POST", ContentType: "body"},
				GetCalendarDetails: dto.EndP{Address: "/taraaz/v1/pricing/calendar/%v", Method: "GET", ContentType: "body"},
