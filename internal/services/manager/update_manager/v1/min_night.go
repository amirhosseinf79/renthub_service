...
func (s *sm) asyncMinNight(service request_v1.SiteEntry, limitDays int, chResult chan request_v1.ServiceStats) {
...
func (s *sm) MinNightUpdate(limitDays int) request_v1.ManagerResponse {
