...
func (s *sm) asyncCalendar(service request_v1.SiteEntry, action string, chResult chan request_v1.ServiceStats) {
...
func (s *sm) CalendarUpdate(action string) request_v1.ManagerResponse {
