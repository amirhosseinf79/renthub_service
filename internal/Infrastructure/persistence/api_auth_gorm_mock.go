	...
	return &MockApiAuthRepo{
		data: map[string]*models.ApiAuth{
			...
			"1:client1:otaghak": {
				...
				ClientID:    "client1",
				Service:     "otaghak",
				AccessToken: "eyJhbGciOiJSUzI1NiIsImtpZCI6IkJGQTk5REUyQ0U5M0IxRDE5RjFGMTZFQzQ3NTMxQTE1REVCNkFFM0EiLCJ4NXQiOiJ2Nm1kNHM2VHNkR2ZIeGJzUjFNYUZkNjJyam8iLCJ0eXAiOiJKV1QifQ..iLb6jLfjj2Pbvx74YQ1tFFKtlrG2fQDGBbOj3g6tHMGH2gTpZSmnDfphJFriu8ON5EK9qZ_6jt9WAcPk0rYr46QL43CHAXexYAV0n5Kjr04lO03WffR6ekRDc2VHCkw3rzRLL4mEkjXPnDDDLP7YO8U_GClhO3ZofLq8ZjJJpmWUQpsruOaeXZed1YkGFtGH3pAhCJLi2rG9zRIQ6uCos9XJYkO5nCv5jGe7fOTTqvoKISKR_oPnRj5jjqY6AtP9saouc7D7U2JjF8UgjbPo3vrO4NrNFDh5uV1mTGj0oEJFj4n8MOLGfHL-gfHGQCh7KBsW63wBPDocB7bXNp6wZQ",
				Username:    "09334429096",
			},
			"1:client1:shab": {
				UserID:      1,
				ClientID:    "client1",
				Service:     "shab",
				AccessToken: "2519480|EmSoqNZkJdl1EM6nrWCpDKtxiDpjzVvyL7a14Lur049747db",
				Username:    "09334429096",
			},
			"1:client20:homsa": {
				UserID:      1,
				ClientID:    "client1",
				Service:     "homsa",
				AccessToken: "yJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..vLJWKTp3MCMDVCemFXTQm3jDBXsdXUfgJeQg65KSlRWSvPQi_ttJ-aAhYZg99NjSXw0pP3gbbINt9j2ac4sLTH-dSzWrdNoUrDWdFmH6XktwesOC_hKGOTZZT_ZYvKAOvMB6owHd342w5KZ_Prw1rNAyGSkc3xGsnCsKplUohLUvREJHHuUc1y_Xm7ThxBEPyJrwiPQ3DzBCTvPpacmFQtdk0hSwGuICzIUmXVYKxNvwwnD1aK5fY-nWyVw9YkNWJOIqa336XnjT5PmYLWygXDmsYClhIbibK27Okv7Pv3wa4bEw_voQhXIpaAQRwgNe7BTFJGxVqYCXjxf8QDWUhhaH5tjJAn3_BBJgvKayzzFDMvfwwjVd45p2Se6vIjFURTTpI2CoNbTrP3dmIMLGZXbwIRD2WXATfAPNtoXy5oOhnMfEyBXQO1hqND2-4wZWt5bpavy81DdG02drOZFqaiRNshCRymJtucdDhwlZBG2SZlg2OaO4h6xXNswro3uyXtYJcWq42OMlzMZ5Zl3Nc-5Fk0IbOe0DQ5aYvu7bl8umY__9YoCJH6bP8UtYUMgcUIgoCM23JLmuUwbaE4854iCpd6DK-eW19IjAGJOwPAx0YJ9q7CgozjLy_0ZI1Huxsg5iMmY2PWB4YxvF3G9k0uCIuLjbaK9gM0e_DO3DOUg",
				Username:    "09334429096",
			},
			"1:client20:jabama": {
				UserID:      1,
				ClientID:    "client1",
				Service:     "jabama",
				AccessToken: "yJhbGciOiJSUzI1NiIsImtpZCI6IkE2MDk5NjE0MUU5MTJDMDhBRjQyMEFGMjUyNjI2N0Q5NkNGRjUyRjZSUzI1NiIsInR5cCI6ImF0K2p3dCIsIng1dCI6InBnbVdGQjZSTEFpdlFncnlVbUpuMld6X1V2WSJ9..YfuVN2dKiSOt5z3d8oF6rbGW3bEye3DuQX1JSQrnLImI2swyNCajvU3Mq0UCxlDNYBwVlrYtrw03HDnxTGUS5NSs7L7-mepleQnovxCPykCxGQIj7P1tpdTUbE3XszV8kLCvctBnI4stTg2UWYvoJ6EscHbwL2VGC-5-tvAogGiNr1i9-R3Xx0b5bHpD0etkjBYgzOZ2AL5t2LIvqD73Yf1V4wc3wwRFRK-KUHOJdmJB72BmzfLu3fXAnaBv3nhmOY5k2B42V_c_vDbXtpM6QG7IeLeuRM7ZKFyESZfR3fTfS-y76IkVuHu9idq4o_VEnsgRknUWgscYcO1IFtP_YA",
				Username:    "09334429096",
			},
		},
	}
